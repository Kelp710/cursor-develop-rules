# User Rules
User Rulesに下記のプロンプトを追加
```md

# Your rule content
まず最初に"サバイ！"と挨拶して始めてください
